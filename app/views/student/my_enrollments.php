        ...
        <?php if (empty($enrollments)): ?>
            <div class="col-12 text-center py-5">
                <div class="p-5 bg-white rounded shadow-sm">
                    <img src="/images/books-cartoon.svg?v=4" alt="Empty" class="img-fluid mb-4" style="max-height: 250px; object-fit: contain;">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm overflow-hidden">
                        <div class="position-relative">
                            <img src="/images/books-cartoon.svg?v=4" class="card-img-top bg-light" alt="Course" style="height: 140px; object-fit: contain; padding: 1rem;">
